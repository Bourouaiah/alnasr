...
function Landing() {
  return (
    <section id="Home" className="pt-[120px] px-[20px] md:px-[50px] py-[50px] gap-[50px] lg:gap-[20px] flex flex-wrap md:flex-nowrap items-center">
      <div className="w-full md:w-[50%] md:block flex flex-col">
        ...
        <Link to="/alnasr/menu/register" className="mx-auto bg-main-yellow py-[10px] px-[20px] font-medium rounded-2xl text-second-black border border-main-yellow hover:text-main-yellow hover:bg-second-black duration-200">
          Join now
        </Link>
      </div>
